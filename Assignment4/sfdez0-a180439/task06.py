...
Original file is located at
    https://colab.research.google.com/drive/1odMDgQ24xggLZZWSn7nuY8foDR2wTvzs
...
g.add((ns.JaneSmith, FOAF.email, Literal("janeSmith@example.com", datatype=XSD.string)))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
